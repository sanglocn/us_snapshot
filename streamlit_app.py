...
def format_pct_color(value, zero_emoji=None, zero_color=None) -> str:
    """Render number with red/green color. Show emoji if exactly 0%."""
    try:
        v = float(value)
    ...
    # Exactly 0 → show emoji instead of number
    ...
    for group_name in GROUP_ORDER:
        ...
        for ticker in tickers_in_group:
            ...
            rows.append({
                ...
                "52W High": format_pct_color(row.get("pct_below_high"), zero_emoji="🟢", zero_color="#16a34a"), 
                "52W Low": format_pct_color(row.get("pct_above_low"), zero_emoji="🔴", zero_color="#dc2626"),
                "  ": "",
